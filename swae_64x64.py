...
LOG_DIR = "/srv/glusterfs/jwu/logs_aaai" # Directory for Tensorboard events, checkpoints and samples
...
if not LOAD_CHECKPOINT:
    ...
    DIR = "baseline_swae3_began_block3_" + str(FEATURE_DIM) + '_' + str(BIN)
else:
    DIR = "baseline_swae3_began_block3_" + str(FEATURE_DIM) + '_' + str(BIN)
